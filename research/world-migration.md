---
title: "World Migration"
layout: single
permalink: /research/exams/world-migration/
---
...
<details open>
<summary><strong>World Migration</strong> (click to collapse)</summary>
...
document.getElementById('ref-search').addEventListener('input', function() {
  ...
  document.querySelectorAll('#world-list li').forEach(function(item) {
